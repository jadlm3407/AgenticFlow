                    ...
                    const listenerId = this.peer.listenForGeneralMessages((senderPublicKey, payload) => {
                        ...
                        try {
                            ...
                            if (requestId === req.headers['x-bsv-auth-request-id']) {
                                ...
                                const hasSession = (_c = (_b = this.peer) === null || _b === void 0 ? void 0 : _b.sessionManager.hasSession(senderPublicKey)) !== null && _c !== void 0 ? _c : false;
                                const needsCertificates = (_f = (_e = (_d = this.peer) === null || _d === void 0 ? void 0 : _d.certificatesToRequest) === null || _e === void 0 ? void 0 : _e.certifiers) === null || _f === void 0 ? void 0 : _f.length;
