...
class WalletAuthenticationManager extends CWIStyleWalletManager_1.CWIStyleWalletManager {
    constructor(adminOriginator, walletBuilder, interactor = new CWIStyleWalletManager_1.OverlayUMPTokenInteractor(), recoveryKeySaver, passwordRetriever, wabClient, authMethod, stateSnapshot) {
        ...
        async (presentationKey, wallet, adminOriginator) => {
            const faucetResponse = await this.wabClient.requestFaucet(sdk_1.Utils.toHex(presentationKey));
            const paymentData = faucetResponse === null || faucetResponse === void 0 ? void 0 : faucetResponse.paymentData;
            if (!(faucetResponse === null || faucetResponse === void 0 ? void 0 : faucetResponse.success) || !paymentData) {
                throw new Error(`Faucet request failed: ${(faucetResponse === null || faucetResponse === void 0 ? void 0 : faucetResponse.message) || 'Missing paymentData from WAB'}`);
            }
