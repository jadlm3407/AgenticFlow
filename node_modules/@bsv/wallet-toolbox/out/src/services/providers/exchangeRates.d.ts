...
export declare function updateChaintracksFiatExchangeRates(targetCurrencies: string[], options: WalletServicesOptions): Promise<FiatExchangeRates>;
...
export declare function getExchangeRatesIo(key: string, symbols?: string[]): Promise<ExchangeRatesIoApi>;
