...
class ChaintracksStorageBase {
    ...
    async addLiveHeadersToBulk(liveHeaders) {
        ...
        const previousWork = (0, blockHeaderUtilities_1.subWork)(firstHeader.chainWork, (0, blockHeaderUtilities_1.convertBitsToWork)(liveHeaders[0].bits));
        const incrementalWork = (0, blockHeaderUtilities_1.subWork)(lastChainWork, previousWork);
