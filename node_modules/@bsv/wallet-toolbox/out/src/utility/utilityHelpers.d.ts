 ...
 */
export declare function toLookupNetworkPreset(chain: Chain): 'mainnet' | 'testnet' | 'local';
 ...
 * @publicbody
 */
export declare function sha256Hash(data: number[] | Uint8Array): number[];
/**
 ...
 * @publicbody
 */
export declare function doubleSha256LE(data: number[] | Uint8Array): number[];
/**
 * Calculate the SHA256 hash of the SHA256 hash of an array of bytes.
 ...
 * @publicbody
 */
export declare function doubleSha256BE(data: number[] | Uint8Array): number[];
/**
