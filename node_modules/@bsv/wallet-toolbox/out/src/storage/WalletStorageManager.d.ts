...
import { TableCertificate, TableCertificateX, TableOutput, TableOutputBasket, TableProvenTx, TableProvenTxReq, TableSettings, TableUser } from '../storage/schema/tables';
...
export declare class WalletStorageManager implements sdk.WalletStorage {
    ...
    createAction(vargs: Validation.ValidCreateActionArgs): Promise<sdk.StorageCreateActionResult>;
     ...
     * @returns
     */
    reproveHeader(deactivatedHash: string): Promise<sdk.ReproveHeaderResult>;
    /**
     ...
     */
    reproveHeightMerkleRoot(height: number, staleMerkleRoot: string): Promise<sdk.ReproveHeaderResult>;
    /**
     * Attempt to reprove the transaction against the current chain,
     ...
     * @returns
     */
    reproveProven(ptx: TableProvenTx, noUpdate?: boolean): Promise<sdk.ReproveProvenResult>;
