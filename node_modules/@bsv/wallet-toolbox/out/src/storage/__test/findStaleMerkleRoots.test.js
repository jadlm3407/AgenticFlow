...
describe('findStaleMerkleRoots test', () => {
    test('0 returns distinct merkle roots at the target height excluding the provided root', async () => {
        ...
        const roots = await index_client_1.StorageProvider.prototype.findStaleMerkleRoots.call(storage, args);
...
//# sourceMappingURL=findStaleMerkleRoots.test.js.map