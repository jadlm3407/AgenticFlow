...
const fundWalletP2PKH_1 = require("./fundWalletP2PKH");
...
class SetupClient {
    ...
    static async createWallet(args) {
        ...
        const monopts = Monitor_1.Monitor.createDefaultWalletMonitorOptions(chain, storage, services, undefined, 'default');
    ...
    static async fundWalletFromP2PKHOutpoints(wallet, outpoints, p2pkhKey, inputBEEF) {
        return (0, fundWalletP2PKH_1.fundWalletFromP2PKHOutpoints)(wallet, outpoints, p2pkhKey, SetupClient.getUnlockP2PKH.bind(SetupClient), inputBEEF);
    }
    /**
