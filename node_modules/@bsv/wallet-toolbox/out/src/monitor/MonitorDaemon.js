...
class MonitorDaemon {
    ...
    async createSetup() {
        ...
        if (!a.monitor) {
            ...
            const monitorOptions = Monitor_1.Monitor.createDefaultWalletMonitorOptions(a.chain, a.storageManager, a.services, a.chaintracks, a.startupTaskMode || 'multiuser');
