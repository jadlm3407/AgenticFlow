 ...
 */
export declare const ARGON2ID_DEFAULT_ITERATIONS = 7;
export declare const ARGON2ID_DEFAULT_MEMORY_KIB = 131072;
export declare const ARGON2ID_DEFAULT_PARALLELISM = 1;
export declare const ARGON2ID_DEFAULT_HASH_LENGTH = 32;
/**
...
export declare class CWIStyleWalletManager implements WalletInterface {
    ...
    adminOriginator: OriginatorDomainNameStringUnder250Bytes) => Promise<void>, stateSnapshot?: number[], kdfConfig?: KdfConfig);
    /**
