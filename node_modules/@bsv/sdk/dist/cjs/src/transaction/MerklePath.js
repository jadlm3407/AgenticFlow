...
class MerklePath {
    ...
    cachedFindLeaf(height, offset, sourceIndex, hashCache, maxOffset) {
        ...
        const doHash = (m) => (0, utils_js_1.toHex)((0, Hash_js_1.hash256)((0, utils_js_1.toArray)(m, 'hex').reverse()).reverse());
        let leaf = height < sourceIndex.length
